...
<svelte:head>
    <title>TutelMod - Support Us</title>
    <meta name="title"                   content="TutelMod - Support Us" />
    <meta property="og:title"            content="TutelMod - Support Us" />
...
<div class="main">
    ...
    <div class="section-info">
        <div>
            ...
            <p>
                <LocalizedText
                    text="Help TutelMod pay for our servers, link & more!"
    ...
    <div class="section-discussion-wrapper">
        <div class="section-discussions">
            <div class="section-discussion">
                <p>
                    <LocalizedText
                        text="TutelMod helps people around the world create the games that they want and share the fun stuff they make with the community."
                        key="donate.message1"
                        lang={currentLang}
                    />
                </p>
                <p>
                    {@html generateMarkdown(`${TranslationHandler.textSafe(
                        "donate.people1",
                        currentLang,
                        "In the last month, ***$1 new people found TutelMod*** and we sent our website to ***$2*** returning users."
                    )
                    ...
                    {@html generateMarkdown(`${TranslationHandler.textSafe(
                        "donate.people2",
                        currentLang,
                        "Some people even use TutelMod from the **United Kingdom**, **Japan**, **Brazil**, **Russia**, and more."
                    )}`)}
                </p>
                <p>
                    <LocalizedText
                ...
                <p class="small">
                    <LocalizedText
                        text="TutelMod is not affiliated with Scratch, TurboWarp, the Scratch Team, or the Scratch Foundation."
